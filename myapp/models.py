...
class Billing(models.Model):
    bill_id = models.CharField(primary_key=True, max_length=20)
    booking_id = models.CharField(max_length=20, blank=True, null=True)
    date = models.DateField(blank=True, null=True)
    bill_type = models.CharField(max_length=9, blank=True, null=True)
...
class Bookingdetails(models.Model):
    ...
    registration_no = models.CharField(max_length=11, blank=True, null=True)
    vehicle_id = models.CharField(max_length=17, blank=True, null=True)
    vehicle_status = models.CharField(max_length=14, blank=True, null=True)
...
class Models(models.Model):
    model_name = models.CharField(primary_key=True, max_length=20)
